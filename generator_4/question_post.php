...
if(isset($_POST['submit'])){
    ...
    $p_question = isset($_POST['question']) ? $_POST['question'] : NULL;
...
<div class="question-container">
    ...
    <form action="<?php echo $_SERVER['SCRIPT_NAME'] ?>" method="post">
        ...
        <textarea class="form-question"  name="question" cols="" rows=""></textarea>
        ...
        <button class="from-button-question" type="submit" name="submit">質問を投稿する</button>
