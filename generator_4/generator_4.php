...
if(isset($_POST['g_submit'])){
    ...
    //属性
    $s_zokusei = isset($_POST['s_zokusei']) ? $_POST['s_zokusei'] : 0;
    $s_h = isset($_POST['s_h']) ? $_POST['s_h'] : 0;
    //フォームのチェックボックスを保存するため、値をセッションに保存
    $_SESSION['ch_zokusei']  = $s_zokusei;
    $_SESSION['ch_h']  = $s_h;
...
<div class="question-container">
    ...
    <form action="<?php echo $_SERVER['SCRIPT_NAME'] ?>" method="post">
        ...
        <button class="from-button-generation" type="submit" name="g_submit">質問を生成する</button>
    ...
    <form action="<?php echo $_SERVER['SCRIPT_NAME'] ?>" method="post">
        ...
        <div class="review">
            ...
            <button class="from-button-review" type="submit" name="r_submit">評価</button>
        </div>
    </form>
